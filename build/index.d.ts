...
declare const _default: {
    FilterReducer: <TInput, TResult>(predicate: (curr: TInput, acc: TResult) => boolean, reducer: Transducer) => Transducer;
    MapReducer: <TInput_1, TResult_1>(fn: (curr: TInput_1, acc: TResult_1) => TResult_1 | Reduced<TResult_1>, reducer: Transducer) => Transducer;
    ...
    WhileReducer: <TInput_3, TResult_3>(predicate: (curr: TInput_3, acc: TResult_3) => boolean, reducer: Transducer) => Transducer;
    ...
    map: <TInput_4, TResult_6>(fn: (curr: TInput_4, acc: TResult_6) => TResult_6 | Reduced<TResult_6>) => (reducer: Transducer) => Transducer;
    flatMap: <TInput_5, TResult_7>(fn: (curr: TInput_5) => TResult_7 | Reduced<TResult_7>) => (reducer: Transducer) => Transducer;
    filter: <TInput_6, TResult_8>(predicate: (curr: TInput_6, acc: TResult_8) => boolean) => (reducer: Transducer) => Transducer;
